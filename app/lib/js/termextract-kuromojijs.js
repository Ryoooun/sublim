...
termextract-kuromojijsは主として中川教授、 東京大学前田朗、 東京大学小島浩之講師の３者で検討を重ね、この「専門用語自動抽出システム」を改良したTermExtractをベースに、日本語の専門用語自動抽出の基本機能をnode.js(JavaScript)に移植したものである。
*/
const version = "0.01b";
...
exports.cmp_noun_list = cmp_noun_list;
exports.list2key_value = list2key_value;
exports.score_lr = score_lr;
